...
서버는 동적 라이브러리를 `./lib/lib*.so` 경로에서 로드하므로 반드시 `exec` 디렉터리에서 실행합니다.
...
| 평가 요소 | 구현 여부 | 코드 위치 |
| --- | --- | --- |
| LED on/off 제어 | [v] | `code/client/client.c:67`, `code/client/client.c:70`, `code/server/src/server.c:462`, `code/server/src/server.c:467`, `code/server/lib/led.c:37`, `code/server/lib/led.c:49` |
| LED 밝기 조절 | [v] | `code/client/client.c:72`, `code/client/client.c:79`, `code/client/client.c:93`, `code/server/src/server.c:472`, `code/server/lib/led.c:61` |
| 부저 on/off 제어 | [v] | `code/client/client.c:95`, `code/client/client.c:98`, `code/server/src/server.c:485`, `code/server/src/server.c:490`, `code/server/lib/buzzer.c:89`, `code/server/lib/buzzer.c:116` |
...
| 조도 센서 값 확인 | [v] | `code/client/client.c:101`, `code/client/client.c:201`, `code/client/client.c:207`, `code/server/src/server.c:495`, `code/server/src/server.c:499`, `code/server/lib/light.c:24` |
| 조도 센서 값에 따른 LED 자동 제어 | [v] | `code/server/lib/light.c:30`, `code/server/lib/light.c:32`, `code/server/lib/light.c:34`, `code/server/lib/light.c:37`, `code/server/src/server.c:254`, `code/server/src/server.c:258` |
| 7세그먼트 숫자 표시 | [v] | `code/client/client.c:107`, `code/client/client.c:116`, `code/server/src/server.c:585`, `code/server/src/server.c:587`, `code/server/lib/fnd.c:28` |
...
| 평가 요소 | 구현 여부 | 코드 위치 |
| --- | --- | --- |
| 메인 프로세스 사용 | [v] | `code/server/src/server.c:281`, `code/client/client.c:305` |
| 멀티 프로세스 사용 | [v] | `code/client/client.c:252`, `code/client/client.c:258`, `code/client/client.c:264`, `code/client/client.c:283` |
| 스레드 사용 | [v] | `code/server/src/server.c:254`, `code/server/src/server.c:505`, `code/server/lib/buzzer.c:58`, `code/server/lib/buzzer.c:104` |
| 데몬 프로세스 구현 | [v] | `code/server/src/server.c:302`, `code/server/src/server.c:304`, `code/server/src/daemon.c:14`, `code/server/src/daemon.c:25`, `code/server/src/daemon.c:31` |
| TCP 서버 socket 구현 | [v] | `code/server/src/server.c:360`, `code/server/src/server.c:390`, `code/server/src/server.c:401`, `code/server/src/server.c:423`, `code/server/src/server.c:436` |
...
| 동적 라이브러리 로딩 | [v] | `code/server/src/server.c:310`, `code/server/src/server.c:311`, `code/server/src/server.c:317`, `code/server/src/server.c:324`, `code/server/src/server.c:332`, `code/server/src/server.c:342`, `code/server/src/server.c:348`, `code/server/src/server.c:616` |
...
| 파일 기반 상태 공유 | [v] | `code/server/src/server.c:60`, `code/server/src/server.c:148`, `code/server/src/web_status.c:11`, `code/server/src/web_status.c:29` |
